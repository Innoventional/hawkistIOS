...
- (void) initDefault
{
    ...
    self.addAlert = [[UIAlertView alloc]initWithTitle:@"Import Billing Address" message:@"Set your Bank Account Address to the Billing Address of the most recently registered bank card?" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"OK", nil];
